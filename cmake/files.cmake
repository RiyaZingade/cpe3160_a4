...
configure_file("${CMAKE_CURRENT_SOURCE_DIR}/STM32L476RGTX_FLASH.ld" "${CMAKE_CURRENT_BINARY_DIR}" COPYONLY)

set_target_properties(${PROJECT_NAME} PROPERTIES LINK_DEPENDS "${CMAKE_CURRENT_BINARY_DIR}/STM32L476RGTX_FLASH.ld")
